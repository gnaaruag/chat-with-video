...
export async function POST(req: Request) {
  ...
  const textPrompt = "You are given a video, you have to summarize it in as detail as possible";
  ...
  try {
    ...
    return NextResponse.json({ message: result.response.text(), fileUri: fileUri });
